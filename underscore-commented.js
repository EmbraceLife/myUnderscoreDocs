...
(function() {
  ...
  */
   ...
   */
  internalFunctions.group = function(behavior, partition) {
  ...
  var group = internalFunctions.group;

  // Groups the object's values by a criterion. Pass either a string attribute
  // to group by, or a function that returns the criterion.

  /**  
   * **_.groupBy(obj, iteratee, context)** implement in two steps: 1. gather an empty container, element, and callbackResultOfEachElement; 2. apply a function 'behavior' to organize element by callbackResultOfEachElement.
